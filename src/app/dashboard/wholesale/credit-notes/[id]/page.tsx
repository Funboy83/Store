  ...
  return (
    <div className="max-w-4xl mx-auto flex flex-col gap-6">
      <div className="flex items-center gap-4">
        <Link href={`/dashboard/wholesale/invoices/${creditNote.originalInvoiceId}`} passHref>
        ...
        <div>
          ...
          <p className="text-muted-foreground">For Customer: <Link href={`/dashboard/wholesale/customers/${creditNote.customerId}`} className="font-semibold text-primary hover:underline">{creditNote.customerName}</Link></p>
        </div>
      </div>
            ...
            <div className="pt-6 border-t">
                ...
                <div className="space-y-3">
                    ...
                    {creditNote.newExchangeInvoiceId && (
                         <Link href={`/dashboard/wholesale/invoices/${creditNote.newExchangeInvoiceId}`} passHref>
                            <div className="flex items-center gap-3 p-3 bg-muted/50 rounded-lg hover:bg-muted transition cursor-pointer">
