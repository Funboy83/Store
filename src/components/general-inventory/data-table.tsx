...
interface GeneralInventoryDataTableProps<TData, TValue> {
...
export function GeneralInventoryDataTable<TData, TValue>({
  columns,
  data,
  rowSelection,
  ...
  onRowClick,
  hideActions,
}: GeneralInventoryDataTableProps<TData, TValue>) {
